...
class AdicionarProjectoPage extends StatefulWidget {
  @override
  _AdicionarProjectoPageState createState() => _AdicionarProjectoPageState();
}

class _AdicionarProjectoPageState extends State<AdicionarProjectoPage> {
  ...
  Future<void> _salvarFormulario() async {
    if (_formKey.currentState!.validate() && dataInicio != null && dataFim != null && tipoProjetoSelecionado != null && statusSelecionado != null) {
      ...
      await DBHelper().insertProjeto(projeto);
          ...
          child: ListView(
            children: [
              ...
              ElevatedButton(
                ...
                child: const Text('Adicionar Projecto', style: TextStyle(fontWeight:  FontWeight.bold,color: Color(0xFFFFFFFF)),),
              ),
            ],
          ),
        ),
